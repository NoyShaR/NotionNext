...
const CONFIG = {
  ...
  STARTER_LOGO: '/images/starter/logo/logo.webp', // 普通logo图片 示例：/images/starter/logo/logo.svg
  ...
  STARTER_HERO_PREVIEW_IMAGE: '/images/starter/hero/star.webp', // 产品预览图 ，默认读取public目录下图片
